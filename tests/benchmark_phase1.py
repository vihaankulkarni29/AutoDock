...
REPORT_PATH = Path("TEST_REPORT_PHASE1.md")

TARGETS = [
    {"class": "Antibiotic", "pdb_id": "2XCT", "target": "S. aureus Gyrase", "ligand": "CPF", "challenge": "Baseline validation"},
    {"class": "Antiviral", "pdb_id": "1HXB", "target": "HIV Protease", "ligand": "ROC", "challenge": "Large peptidomimetic"},
    ...
    {"class": "Bio-tool", "pdb_id": "1OQA", "target": "Streptavidin", "ligand": "STR", "challenge": "Ultra-high affinity"},
...
def main() -> None:
    ...
    for target in TARGETS:
        ...
        try:
            ...
            receptor_pdb = workspace / "receptor.pdb"
            ligand_crystal = workspace / "ligand_crystal.pdb"
            ligand_input = workspace / "ligand_input.pdb"
            receptor_pdbqt = workspace / "receptor.pdbqt"
            ligand_pdbqt = workspace / "ligand_input.pdbqt"
            docked_pdbqt = workspace / "ligand_docked.pdbqt"
